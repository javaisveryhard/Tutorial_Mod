package net.scoop.tutorialmod.world.feature;
...
public class ModPlacedFeatures {
 ...
 public static final RegistryObject<PlacedFeature> NETHER_ZIRCON_ORE_PLACED = PLACED_FEATURES.register("nether_zircon_ore_placed",
    ...
    public static List<PlacementModifier> commonOrePlacement(int p_195344_, PlacementModifier modifier) {
        return orePlacement(CountPlacement.of(p_195344_), modifier);
    }
